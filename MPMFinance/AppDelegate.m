...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [barButtonAppearance setTintColor:[UIColor whiteColor]]; // Change to your colour
...
- (void)tokenRefreshNotification:(NSNotification *)notification {
    ...
    [[NSUserDefaults standardUserDefaults] setObject:[[FIRInstanceID instanceID] token] forKey:@"fcmId"];
...
{
    //check udah login blm.
    //if yes, ke storyboard yg udah login
}

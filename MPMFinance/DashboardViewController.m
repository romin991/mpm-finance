...
-(void)downloadData
{
    ...
    [manager POST:[NSString stringWithFormat:@"%@/dasboard",kApiUrl] parameters:param progress:^(NSProgress * _Nonnull uploadProgress) {
        ...
        if ([responseObject[@"statusCode"] isEqual:@200]) {
            [self addSliceItemsWithTotalReject:responseObject[@"data"][@"reject"] andApprove:responseObject[@"data"][@"approve"]];
...
- (void)addSliceItemsWithTotalReject:(NSString*)rejectString andApprove:(NSString*)approveString {

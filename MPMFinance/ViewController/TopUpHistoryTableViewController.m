//
//  TopUpHistoryTableViewController.m
//  MPMFinance
//
...
@interface TopUpHistoryTableViewController ()

@property NSArray *datas;

@end

@implementation TopUpHistoryTableViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (!cell){
        [tableView registerNib:[UINib nibWithNibName:@"TopUpTableViewCell" bundle:nil] forCellReuseIdentifier:@"Cell"];

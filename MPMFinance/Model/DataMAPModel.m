        ...
        if ([responseObject[@"statusCode"] isEqual:@200]) {
            ...
            @try {
                ...
                dictionary = [NSMutableDictionary dictionaryWithDictionary:@{
                               ...
                               @"pokokHutang" : @([data[@"pokok_hutang"] doubleValue]),
                               @"subsidiUangMuka" : @([data[@"subsidi_dp"] doubleValue]),
                               ...
                               @"angsuran" : @([data[@"angsuran"] doubleValue]),
                               ...
                               @"asuransiJiwaKreditKapitalisasi" : @([data[@"asuransi_jiwa_kapitalisasi"] integerValue]),
                               @"nilaiPertanggunganAsuransiJiwa" : @([data[@"nilai_pertanggungan_asuransi"] integerValue]),
                               @"premiAsuransiKerugianKendaraan" : @([data[@"premi_asuransi_kerugian_kendaraan"] integerValue]),
                               @"premiAsuransiJiwaKredit" : @([data[@"premi_asuransi_jiwa_kredit"] integerValue]),
                               @"perusahaanAsuransiJiwa" : data[@"perusahaan_asuransi_jiwa"],
                               @"tipeAsuransi" : data[@"tipe_asuransi"],
                               @"asuransiKendaraanKapitalisasi" : @([data[@"asuransi_kendaraan_kapitalisasi"] integerValue]),
                               @"asuransiKendaraanDibayarDimuka" : data[@"asuransi_kendaraan_dp"],
                               @"asuransiJiwaDibayarDimuka" : @([data[@"asuransi_jiwa_dp"] integerValue]),

...
NSString *const kBaseUrl = @"http://202.152.10.90:8080"; //dev
NSString *const kBaseUrlWithoutPort = @"http://202.152.10.90"; //dev
//NSString *const kApiUrl = @"http://202.152.10.90:8080/mpmfinancev2"; //dev
